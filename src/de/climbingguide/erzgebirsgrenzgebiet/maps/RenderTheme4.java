...
public class RenderTheme4 extends SamplesBaseActivity implements XmlRenderThemeMenuCallback {
	...
	protected XmlRenderTheme getRenderTheme() {
		try {
			...
			Log.e(ClimbingGuideApplication.TAG, "Render theme failure " + e.toString());
		}
		return null;
	}
	...
	public Set<String> getCategories(XmlRenderThemeStyleMenu menuStyle) {
		...
		if (baseLayer == null) {
			Log.w(ClimbingGuideApplication.TAG, "Invalid style " + id);
			return null;
		}
	...
	public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
		...
		// for the style menu.
		Log.i(ClimbingGuideApplication.TAG, "Purging tile caches");
